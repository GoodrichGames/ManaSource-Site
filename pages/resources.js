      ...
      <section>
        <div>
          <div>
            <ul>
              {/* <li>
                <h3>Watch it Played</h3>
                <div>
                  Coming soon!
                </div>
              </li> */}
              {/* <li>
                <h3>Download the Rulebook</h3>
                <div>
                  Coming soon!
                </div>
              </li> */}
              <li>
                ...
                <div style={{ position: 'relative', height: '22rem' }}>
                  <Image src='/images/Recharge Zone explanation.png' alt='Image of how cards move down the recharge zone when played' layout='fill' objectFit='contain' priority={true} />
                </div>
                <br />
              </li>
              <li>
                <h3>Explore the classes</h3>
                <div>
                  <p>
                    <b>Reagent</b><br />
                    <em>Eleformer</em><br />
